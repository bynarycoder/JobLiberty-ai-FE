...
export const FILTER_OPTIONS = {
  ...
  categories: ['all', 'jobs', 'scholarships', 'fellowship', 'internships', 'hackathons', 'learning_resources', 'competition', 'networking', 'volunteer'],
  opportunityTypes: ['all', 'jobs', 'scholarships', 'fellowship', 'internships', 'hackathons', 'learning_resources', 'volunteer'],
